...
module ChirpStackAPI
  module META
    UplinkMeta = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("meta.UplinkMeta").msgclass
    DownlinkMeta = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("meta.DownlinkMeta").msgclass
  end
end
