...
begin
  ...
  imports = [
    ["api.Measurement", "api/device_profile.proto"],
...
module ChirpStackAPI
  module API
    DeviceProfileTemplate = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("api.DeviceProfileTemplate").msgclass
    DeviceProfileTemplateListItem = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("api.DeviceProfileTemplateListItem").msgclass
    CreateDeviceProfileTemplateRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("api.CreateDeviceProfileTemplateRequest").msgclass
    GetDeviceProfileTemplateRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("api.GetDeviceProfileTemplateRequest").msgclass
    GetDeviceProfileTemplateResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("api.GetDeviceProfileTemplateResponse").msgclass
    UpdateDeviceProfileTemplateRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("api.UpdateDeviceProfileTemplateRequest").msgclass
    DeleteDeviceProfileTemplateRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("api.DeleteDeviceProfileTemplateRequest").msgclass
    ListDeviceProfileTemplatesRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("api.ListDeviceProfileTemplatesRequest").msgclass
    ListDeviceProfileTemplatesResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("api.ListDeviceProfileTemplatesResponse").msgclass
  end
end
